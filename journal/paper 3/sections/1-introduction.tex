...
paper documents both for HunStat2, using its own C++ class structure as
evidence rather than the presence of a \texttt{class} keyword alone
(Section~\ref{sec:instrument-design}), and focuses its own diagnosis and
fix on the first concern. A wrong signal path or a wrong ADC convention
