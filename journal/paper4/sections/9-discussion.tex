...
The eleven defects fixed in this paper are not structurally alike, and
...
(the HS loop) for the wrong purpose -- diagnosable by direct comparison
...
comparison at the level of ``which loop is configured'' would not by
...
\item \textbf{Sample timing precision.} This project's \texttt{delay()}-based
  ...
  larger. This is unrelated to, and not fixed by, the eleven corrections
