...
modes are easy to miss without a correctly-working reference to compare
...
guarantee a correct instrument. This paper reports an eleven-defect
...
formulas. Two of the eleven defects (excitation/sensing loop selection and
...
\item A structured, file-by-file and register-by-register comparison of
...
\item Diagnosis and correction of eleven concrete firmware defects
  (Section~\ref{sec:validation}) found by that comparison and by the
